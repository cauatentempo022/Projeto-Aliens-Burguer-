...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($senha !== $csenha) {
        ...
        if ($result->num_rows > 0) {
            ...
            $sql = "INSERT INTO usuarios (nome, email, telefoneF, telefoneC, nomeMaterno, cpf, cep, rua, bairro, estado, cidade, login, senha, csenha, genero)
                    VALUES ('$nome', '$email', '$telefoneF', '$telefoneC', '$nomeMaterno', '$cpf', '$cep', '$rua', '$bairro', '$estado', '$cidade', '$login', '$senhaHash', '$senhaHash', '$genero')";
